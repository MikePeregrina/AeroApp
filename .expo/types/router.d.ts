...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/Home` | `/Home` | `/(tabs)/MisClases` | `/MisClases` | `/(tabs)/Perfil` | `/Perfil` | `/context/ScrollContext` | `/screen/comprarcurso/AgendarCurso` | `/screen/comprarcurso/HomeCursoSreen` | `/screen/comprarcurso/MuestraMentor` | `/screen/comprarcurso/SelectFecha` | `/screen/comprarcurso/VerPerfil` | `/screen/login/HomeLoginScreen` | `/screen/login/LoginScreen` | `/screen/login/RegisterScreen` | `/screen/login/ResetPasswordScreen` | `/screen/VerMaster/VerMasters`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/screen/Mentor/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/screen/Mentor/[id]`;
