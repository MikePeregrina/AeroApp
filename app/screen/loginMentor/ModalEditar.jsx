...
export const ModalEditar = ({ props, setUpdate }) => {
  ...
  const handleDate = async () => {
    const data = {
      nuevaFecha: onSelectDia,
      nuevaHora: onSelectHora,
      id: props,
    };
    setLoading(true);
    try {
      const res = await fetchData(
        "https://www.widolearn.com/index.php?c=Docentes&a=actualizarDisponibilidadApp",
        { method: "POST", data: JSON.stringify(data) }
      );
      if (res.success) {
        showToast("info", "En hora Buena ✅", `${res.message},`);
        setUpdate((prev) => !prev);
        setTimeout(() => {
          setLoading(false);
        ...
        <View style={styles.modalContainer}>
          ...
          <View style={styles.modalContent}>
            <View>
              ...
              >
                Seleccione nuevo dia de la semana
              </Text>
